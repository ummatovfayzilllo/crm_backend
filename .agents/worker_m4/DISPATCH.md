...
Siz M4 Doc Worker siz.
Sizning ishchi katalogingiz: `/home/fayzillo/Desktop/Loyihalar/crm/crm_backend/.agents/worker_m4`
...
- `/home/fayzillo/Desktop/Loyihalar/crm/crm_backend/src/modules/lessons/` (controller, service, dto, entity, etc.)
- `/home/fayzillo/Desktop/Loyihalar/crm/crm_backend/src/modules/attendentionals/` (controller, service, dto, entity, etc.)
- `/home/fayzillo/Desktop/Loyihalar/crm/crm_backend/prisma/schema.prisma` (Lesson, Attendance/Attendentionals va bog'liq modellar)

2. Quyidagi 2 ta API hujjatini to'liq yangilang:
- `/home/fayzillo/Desktop/Loyihalar/crm/backend_api_docs/lessons.md`
- `/home/fayzillo/Desktop/Loyihalar/crm/backend_api_docs/attendentionals.md`
...
```
(lessons.md uchun 1 ta xabar, attendentionals.md uchun 1 ta xabar).

5. O'z ishchi katalogingizda (`.agents/worker_m4/`) `progress.md` va `handoff.md` yarating va menga (orchestratorga) hisobot yuboring.
