...
export class AuthController {
  ...
  @ApiOperation({
    summary: 'Universal OTP kod yuborish (Register yoki Reset uchun)',
  })
  async sendOtp(
  ...
  @Post('register')
  @ApiOperation({
    summary: "Yangi foydalanuvchini ro'yxatdan o'tkazish (OTP orqali)",
  })
  async register(
    ...
    this.setTokensToCookies(
      res,
      (<any>result).accessToken || (<any>result).tokens?.accessToken,
      null,
      (<any>result).refreshToken || (<any>result).tokens?.refreshToken,
    );
    return {
